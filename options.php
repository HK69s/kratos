...
function optionsframework_options(){
    ...
    $options[] = array(
        'name'=>'站点图标',
        'id'=>'site_ico',
        'std'=>'https://exiled.top/wp-content/themes/kratos/static/images/favicon.ico',
        'type'=>'upload');
    $options[] = array(
    ...
    $options[] = array(
        ...
        'std'=>'https://exiled.top/img/beijin.jpg',
        'type'=>'upload');
    $options[] = array(
        'name'=>'开启手机背景图片',
        'id'=>'openphoneimg',
    ...
    $options[] = array(
        ...
        'id'=>'phone_img',
        'std'=>'https://exiled.top/img/timg.jpg',
        'type'=>'upload');
    $options[] = array(
        'name'=>'主页布局',
    ...
    $options[] = array(
        ...
        'id'=>'wechatpayqr_url',
        'std'=>'https://exiled.top/img/wechatpayqr.png',
        'type'=>'upload');
    $options[] = array(
        'name'=>'支付婊收款码',
        'desc'=>'上传你的支付婊收款二维码图片，图片尺寸要大于200px',
        'id'=>'alipayqr_url',
        'std'=>'https://exiled.top/img/alipayqr.png',
        'type'=>'upload');
    $options[] = array(
        'name'=>'SEO配置',
        'type'=>'heading');
    ...
    $options[] = array(
        'name'=>'顶部图片',
        'id'=>'background_image',
        'std'=>'https://exiled.top/img/dinbu.jpg',
        'type'=>'upload');
    $options[] = array(
        'name'=>'移动端顶部图片(可留空)',
        'id'=>'background_image_mobi',
        'std'=>'https://exiled.top/img/sjos.jpg',
        'type'=>'upload');
    $options[] = array(
        'name'=>'图片文字-1(可做文字标题)',
    ...
    $options[] = array(
        ...
        'id'=>'login_bak',
        'std'=>'https://exiled.top/img/zc.jpg',
        'type'=>'text');
    $options[] = array(
        'name'=>'注册登录页面站点图标',
        'id'=>'login_logo',
        'std'=>'https://exiled.top/img/default-logo.png',
        'type'=>'upload');
    $options[] = array(
        'name'=>'以下为用户注册部分的设置');
    $options[] = array(
    ...
    $options[] = array(
        ...
        'std'=>'https://exiled.top/img/photo.jpg',
        'type'=>'upload');
    $options[] = array(
        'name'=>'昵称',
        'desc'=>'将在手机端侧边栏展示',
    ...
    $options[] = array(
        ...
        'desc'=>'这里设置你的B博背景',
        'id'=>'bibo_background',
        'std'=>'https://exiled.top/img/sbj.jpg',
        'type'=>'upload');
    $options[] = array(
        'name'=>'推广链接文本',
